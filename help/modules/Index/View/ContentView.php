...
<ul class="tab">
	...
	<li><?=  $Helper->_('.tabmenu.classes') ?></li>
	<li><?=  $Helper->_('.tabmenu.library') ?></li>
</ul>
</div>
 ...
 * @license    MIT
 * @version 0.8.0, 2020-05-03
 * System Require: PHP 5.6 or Higher
 *

1. はじめに
  Biscuit(easyMVC)は Controller-View-Model を参考にしたMVCもどきのフレームワークです。
  ...
  Viewテンプレートは基本的にPHP記述ですが、連想配列を利用してレイアウトを簡単に
